...
def copiar_imagenes(csv, carpeta_imagenes, carpeta_destino):
    ...
    with open(csv, mode='r', encoding='utf-8') as file:
        ...
        for linea in file:
            id_producto = (linea.split(";")[3].strip())  # Suponiendo que el ID del producto está en la primera columna
...
copiar_imagenes(csv= "articulos.csv", carpeta_imagenes= carpeta, carpeta_destino= "EXPORTAR")
